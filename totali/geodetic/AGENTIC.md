...
- 2026-06-18 — G-9 (coded path): coded-survey `.asc` geodetic report proven byte-identical across two runs via committed fixtures (`tests/fixtures/survey_corpus/coded_survey_min.{asc,fld}`), closing the LAS-only gap in the determinism test. `tests/test_geodetic_deterministic.py::TestCodedSurveyReportDeterminism` (2). Suite 962 passed / 2 skipped.
